...
Metoden returnerer en sandhedsværdi for, om regionens masse er
jævnt fordelt. Vi har tidligere fastsat, at regionens masse er jævnt
fordelt, hvis forholdet mellem de to sider er under $0.75$. Metoden gør
brug af snittets orientering, hentet i
...
det $(\lfloor \frac{|\textit{acceptRange}|}{2}\rfloor + 1)$'te element i
$\textbf{Constraints}.\textit{acceptRange}$.
