...
Vi starter med at kigge på fordelingen af en regions masse. Helt enkelt
skal vi bare finde forholdet mellem punkter på højre og venstre side af
snittet. Metoden i kodeboks \ref{pseudo_distribution}, gør netop dette.
Metoden returnerer en sandhedsværdi for, om regionens masse er jævnt
fordelt. Vi har tidligere fastsat, at regionens masse er jævnt fordelt,
hvis forholdet mellem de to sider er under $0.75$. Metoden gør brug af
snittets orientering, hentet i
...
det $(\left\lfloor \frac{|\textit{acceptRange}|}{2}\right\rfloor + 1)$'te
element i $\textbf{Constraints}.\textit{acceptRange}$.
