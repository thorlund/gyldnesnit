...
d4 <- read.table("cut0cut1featsperratio.csv", sep=",",header=TRUE)
d5 <- read.table("cut2cut3featsperratio.csv", sep=",",header=TRUE)
...
dev.off()
png("billeder/cut0cut1featsperratio.png")
barplot(d4$interessante.regioner,bedside=TRUE,names=d4$ratios,cex.names=0.5)
dev.off()
png("billeder/cut2cut3featsperratio.png")
