...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[angle=0,width=0.90\textwidth]{afsnit/resultater/billeder/yearNrImageU.png}
	\end{center}
	\caption{}
	\label{naiv_yearNrImageU}
\end{figure}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[angle=0,width=0.90\textwidth]{afsnit/resultater/billeder/nationNrImageU.png}
	\end{center}
	\caption{}
	\label{naiv_nationNrImageU}
\end{figure}
