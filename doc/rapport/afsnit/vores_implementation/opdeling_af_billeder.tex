...
\being{definition}
	Vært snit har en \textbf{Margin}, som er to linier, der er,
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.42,angle=0]{afsnit/vores_implementation/billeder/naiv_algoritme/margin.png}
	\end{center}
