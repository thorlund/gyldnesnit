...
\begin{enumerate}
    \item Der udregnes en foldningsmatrix. I dette tilfælde er det en
        matrix med kun 1 taler i.
	\item Multiplicerer foldningsmatricen på billedet for en pixel, som
        beskrevet overfor.
	\item Værdierne fra multiplikationen sættes ind i billedet.
	\item Start fra punkt 2 igen, med næste pixel, indtil alle pixels
