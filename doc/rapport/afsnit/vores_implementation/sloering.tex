...
I formlen sætter $\sigma = 1$ og lader x og y bevæge sig fra -1 til 1, med skridtstørrelse på 1, Alle værdier i foldningsmatricen bliver oprundet, resultatet kan ses i figur \ref{gauss}.
