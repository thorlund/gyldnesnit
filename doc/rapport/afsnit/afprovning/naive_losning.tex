...
billeder som vi har valt at test kan se i figur
\ref{naiv_detektion_test} hvor en grån kasse rundt om en region, betyder
...
\begin{figure}[!h]
    \centering
		\subfloat[Kun den nederste højrisondt er fundet]{
		    ...
		    \label{naive_hoisont1}}\hspace{1em}
\end{figure}
...
regnet med. \note{mere plas i teksten og sa skal alle de oginale billeder vere der}
