...
\begin{figure}[!h]
    \centering
		...
		\subfloat[Maleri med middelkraftige farver og medium antal detaljer.]{
...
\begin{figure}[!h]
    \centering
	\subfloat[Maleri med kraftige farver og mange detaljer, hvor tærskelværdierne fundet i afsnit \ref{terskelverdi} er brugt.]{
    ...
    \subfloat[Det samme maleri, hvor tærskelværdier er valgt specifikt for det her maleri]{
...
\begin{figure}[!h]
	...
	\subfloat[Det samme maleri, hvor tærskelværdierne er valgt specifikt for maleriet.]{
...
\begin{figure}[!h]
    \centering
     \subfloat[Tærskelværdierne for floodfill på maleriet er sat til en.]{
...
%I maleri \ref{bla} er kanten tegnet med blåt og man
%kan se at munk nummer to fra venstre, ikke får sit skæg med, men hvor han går
...
\begin{figure}[!h]
    ...
    \subfloat[Maleri med sorte kanter i kantdetektionen.]{
        ...
        \label{sort}}
     \caption{To forskellige farver brugt til at lægge kanter på maleriernes regioner.}
     \label{fleremunke}
\end{figure}
