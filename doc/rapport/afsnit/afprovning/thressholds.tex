...
\begin{figure}[p]
    \centering
    \subfloat[Det original maleri. Navn: The Archangel Michae. År: Ca
	1490 Af: Abadia, Juan de la.]{
...
\begin{figure}[!h]
    ...
    \subfloat[(100,250)]{
        ...
        \caption[]{Kantdetektion på et billedet med svage farver og få
		detaljer, hvor tærskelværdien (100,250) er den bedste.}
     \label{en}
\end{figure}
...
Det ses i tabel \ref{thressholdsTabelKant} at tærskelværdierne går 
