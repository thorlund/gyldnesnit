...
lin-je-styk-ket smel-te smel-tes hvor-vidt hvor-dan da-ta-struk-tur-en
ek-si-ste-ren-de seg-ment-ering}
...
\input{afsnit/afprovning/afprovning.tex}

\chapter{Implementering\label{chap_implementation}}
\input{afsnit/implementation/implementation.tex}

\chapter{Videnskabelige resultater\label{chap_resultater}}
\input{afsnit/resultater/resultater.tex}

\chapter{Fremtidigt arbejde}
\input{afsnit/fremtidigt_arbejde/fremtidigt_arbejde.tex}
